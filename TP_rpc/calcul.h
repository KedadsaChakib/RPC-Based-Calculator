...
extern  response * calcul_addition_1(data *, CLIENT *);
extern  response * calcul_addition_1_svc(data *, struct svc_req *);
...
#define CALCUL_ADDITION 1
extern  response * calcul_addition_1();
extern  response * calcul_addition_1_svc();
